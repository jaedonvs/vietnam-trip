    ...
    { n: 5, title: "Hoi An — Temples, Tailoring & Food", date: "Thu 25 Jun", iso: "2026-06-25", city: "hoian",
      ...
      cols: [
        { h: "Morning & Afternoon", items: [
          ...
          "⭐ Tailor fitting this morning — try-on & adjustments (Izi / I Love Fashion), so it's ready to finish while you're in Hue",
    ...
    { n: 6, title: "Hue Day Trip", date: "Fri 26 Jun", iso: "2026-06-26", city: "hoian",
      ...
      cols: [
        { h: "Full Day", items: [
          ...
          "✅ Hai Van Pass — panoramic summit stop (scenic up; tunnel back to save ~45 min)",
          "✅ Hue Imperial Citadel — 2–3 hours",
          "✅ Thien Mu Pagoda — 7-storey pagoda on the Perfume River",
          "Bun Bo Hue for lunch",
          "✅ Khai Dinh Tomb — the most spectacular & compact (~45 min), on the way back south",
        ]},
        { h: "Evening", items: [
          "Tunnel back to Hoi An (~3 hrs)",
          "Last evening lantern walk",
          "🌧️ Backup: skip the tomb if rain, swap in the Hue Royal Antiquities Museum",
        ]},
      ],
      stay: "Hotel Royal Hoi An, Danang", foot: [] },
